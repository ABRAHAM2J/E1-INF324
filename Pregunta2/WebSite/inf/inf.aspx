<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inf.aspx.cs" Inherits="inf_Default" %>
...
<body>
    ...
    <h4 class="main-subtitle">Carrera de Informatica</h4>
    <div class="menu">
        <div class="container">
            <a href="./inf.aspx" class="card">
